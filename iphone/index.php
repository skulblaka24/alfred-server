   ...
   ##################################################################### */
	...
	if(isset($_POST['username']) && isset($_POST['password']))
	{
		...
		while ($donnees = $req->fetch()) {
			if($donnees['name'] == $username && $donnees['password'] == sha1($password) && ($donnees['registration_number'] == "Admin" || $donnees['registration_number'] == "Alfred"))
				$connexion = true;
			elseif($donnees['name'] != $username && $donnees['password'] == sha1($password) && ($donnees['registration_number'] == "Admin" || $donnees['registration_number'] == "Alfred"))				
				$login = true;
			elseif ($donnees['name'] == $username && $donnees['password'] != sha1($password) && ($donnees['registration_number'] == "Admin" || $donnees['registration_number'] == "Alfred"))
				$mdp = true;
				continue;
...
<!-- Hero Bloc -->
<div id="hero-bloc" class="bloc hero bgc-white bg-fond d-bloc full-wnav-height">

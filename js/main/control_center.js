...
$(document).ready(function () {
		...
		// Action du click sur les boutons
		$('.amp_btn').on('click', function (e) {
			e.stopPropagation();
			var data = ("relai=" + $(this).attr('data-id'));//+  "&content=" + content;
			getOutput(data);

		});
		$('.pri_btn').on('click', function (e) {
			e.stopPropagation();
			var data = ("relai=" + $(this).attr('data-id'));//+  "&content=" + content;
			getOutput(data);
...
// ###########################################################################
		...
		function getOutput(data) {
		  getRequest(
		      '../../page/action/action_relai.php', // URL for the PHP file

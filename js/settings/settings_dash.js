...
// A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER 
// Comme ajouté des infos sur le logos des machines ou un bouton avec un choix genre term ou info
$(document).ready(function () {
	
	
	$('#name').focus();
	// Fonction quant il y a passage de la souris.
	$('.nav-img').hover(function () { // true
...
// A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER A CORRIGER 
	...
	$('.img-mod').click(function () { // true
		...
		_name = $(".dash_tab_n"+_id).attr('data-name');
		var _desc = $(".dash_tab_d"+_id).attr('data-desc');
		var _mach = $(".dash_tab_m"+_id).attr('data-mach');
		var _site = $(".dash_tab_s"+_id).attr('data-site');
		var _type = $(".dash_tab_t"+_id).attr('data-type');

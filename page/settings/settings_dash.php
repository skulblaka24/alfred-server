						...
						<fieldset>
							<div class="form ft-white">
								<div class="bloc-1-input">
								    ...
								    <input class="form-control" type="text" id="name" name="name" placeholder="Nom de la machine" style="width: 170px;" required/><br><br>
								...
								<div class="bloc-2-input">
								    ...
								    <input class="form-control" type="text" name="ip" id="ip" placeholder="Adresse IP" style="width: 170px;" required/><br><br>
					                
					                <label for="label_site">Contenu</label><br>
								    <input class="form-control" type="text" name="site" id="site" placeholder="Site, shell, etc" style="width: 170px;" required/><br><br> 
								</div>
					...
					<div class="col-xs-12 col-md-8 col-md-offset-2">
						<table class="table table-striped table-bordered table-hover">
						    ...
						    <?php $req = $pdo->query('SELECT * FROM `alf_dash`');
						    	...
						    	?>
						    <tr>
							    <td><p class="dash_tab_n<?php echo $data['dash_id'] ?>" data-name="<?php echo $data['dash_name'] ?>"><?php echo $data['dash_name'] ?></p></td>
							    <td><p class="dash_tab_d<?php echo $data['dash_id'] ?>" data-desc="<?php echo $data['dash_description'] ?>"><?php echo $data['dash_description'] ?></p></td>  
					            <td><p class="dash_tab_m<?php echo $data['dash_id'] ?>" data-mach="<?php echo $data['dash_machine'] ?>"><?php echo $data['dash_machine'] ?></p></td>
					            <td><p class="dash_tab_s<?php echo $data['dash_id'] ?>" data-site="<?php echo $data['dash_site'] ?>"><?php echo $data['dash_site'] ?></p></td>
					            <td><p class="dash_tab_t<?php echo $data['dash_id'] ?>" data-type="<?php echo $data['dash_type'] ?>"><?php echo $data['dash_type'] ?></p></td> 
					            <td><button id="dash_mod" class="btn btn-default img-mod" data-id="<?php echo $data['dash_id'] ?>"></button>
